...
for condition in conditions:
    ...
    model = Sequential([
        ...
        # Bidirectional SimpleRNN layers with dropout in between
        Bidirectional(SimpleRNN(units=128, return_sequences=True,
                      dropout=0.2, recurrent_dropout=0.2)),
        Dropout(0.2),  # Dropout between Bidirectional RNN layers
        ...
        # Set return_sequences=False for the final SimpleRNN layer
        Bidirectional(SimpleRNN(units=128, return_sequences=False,
                      dropout=0.2, recurrent_dropout=0.2)),
